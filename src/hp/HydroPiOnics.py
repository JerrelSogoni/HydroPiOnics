...
class HydroPiOnics(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_HYDROPIONICS, name=u'HydroPiOnics',
              parent=prnt, pos=wx.Point(636, 99), size=wx.Size(950, 800),
              style=wx.DEFAULT_FRAME_STYLE, title=u'HydroPiOnics')
        self.SetClientSize(wx.Size(934, 761))
        self.SetBackgroundColour(wx.Colour(196, 233, 253))
        self.SetMaxClientSize(wx.Size(950, 800))
        self.SetMaxSize(wx.Size(950, 800))
        self.SetInitialSize(wx.Size(950, 800))
        self.SetMinClientSize(wx.Size(-1, -1))
        self.Show(True)
        self.SetIcon(wx.Icon(self.IMG_LOCATION + "applicationicon.ico",
              wx.BITMAP_TYPE_ICO))
